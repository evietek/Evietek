    ...
    <>
      ...
      <section className="pt-15 md:pt-0 mt-0 px-6 md:px-16 lg:px-0 relative bg-white select-none cursor-default">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <CaseStudyTitle
            title="Making Epicstreams' Brand Identity Stronger With Powerful Design "
        ...
        <div className="max-w-6xl mx-auto px-6">
          <CaseStudyContent
            ...
            contents={[
              {
                text: "Through strategic development and new solutions, Epicstreams is a dynamic platform that helps businesses and organizations grow and thrive. They needed a strong, consistent brand identity that accurately captured their mission and kept people interested in order to improve their market presence."                // image: {
          ...
          <CaseStudyContent
            ...
            contents={[
              {
                text: "Before working with us, Epicstreams faced several branding and design challenges: "
              },
              {
                list: [
            ...
            contents={[
              {
                ...
                list: [
                  "Developed a modern, professional brand identity that aligns with Epicstreams' mission.",
          ...
          <CaseStudyContent
            ...
            contents={[
              {
                text: "The branding transformation significantly improved Epicstreams' digital and market presence: "
              },
              {
                list: [
                  ...
                  "**Enhanced professionalism and credibility**, helping Epicstreams establish a trusted presence in its industry."
                ]
              }
            ]}
          />
          ...
          <CaseStudyContent
            ...
            contents={[
              {
                text: "**“**  Our new branding has completely transformed how we present ourselves. Our professional touch, clean design, and visually consistent content have given us the credibility and impact we needed to get more businesses to sign up. We couldn’t be happier!**“** **Epicstreams Team**  "
              }
            ]}
          />
          ...
          <CaseStudyContent
            ...
            contents={[
              {
                text: "Epicstreams has a strong, professional, and interesting brand identity that makes them stand out in their industry thanks to the strategic branding design approach we used."
              },
              {
