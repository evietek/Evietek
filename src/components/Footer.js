...
//   return (
//     <footer className="bg-[#030438] text-white pt-14 pb-7 relative select-none">
...
// <div className="max-w-6xl mx-auto px-6 mt-12 mb-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 text-white justify-items-center">
//   {/* Services */}
//   <div>
//     <h3 className="text-2xl font-semibold mb-6 text-white">Services</h3>
//     <ul className="space-y-1 text-lg text-gray-300">
//       <li><a href="/website-design" className="hover:text-[#5E51FE] transition-colors">Web Designing</a></li>
...
//       <li><a href="/illustrations" className="hover:text-[#5E51FE] transition-colors">Illustration</a></li>
...
//     <ul className="space-y-1 text-lg text-gray-300">
//       <li><a href="#" className="hover:text-[#5E51FE] transition-colors">Ecommerce App Development</a></li>
//       <li><a href="#" className="hover:text-[#5E51FE] transition-colors">Food Delivery App Development</a></li>
//       <li><a href="#" className="hover:text-[#5E51FE] transition-colors">Healthcare App Development</a></li>
//       <li><a href="#" className="hover:text-[#5E51FE] transition-colors">Real Estate App Development</a></li>
//       <li><a href="#" className="hover:text-[#5E51FE] transition-colors">IT Staff Augmentation</a></li>
//     </ul>
//   </div>

//   {/* Quick Links */}
//   <div>
//     <h3 className="text-2xl font-semibold mb-6 text-white">Quick Links</h3>
//     <ul className="space-y-1 text-lg text-gray-300">
...
export default function Footer() {
  return (
    <footer className="bg-[#030438] text-white pt-20 pb-7 relative select-none">
      ...
      {/* Footer Links Section */}
      <div className=" mx-auto px-6 mt-12 mb-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 text-white justify-items-center bg-[#1A1D5A] py-8">
        {/* Services */}
        <div className="my-6">
          <h3 className="text-2xl font-semibold mb-6 text-white">Services</h3>
          <ul className="space-y-1 text-lg text-gray-300">
