...
// export default function ServiceCard({ background, title, description, icon, decoration, borderColor }) {
...
//       {/* Card Title */}
//       <motion.h3
//         className="mt-4 z-10 text-[30px] sm:text-[36px] leading-[103%] font-semibold text-[#3E2472] text-center font-bricolage"
//         variants={contentVariants}
//       >
//         {title}
//       </motion.h3>
...
//       {/* Card Description */}
//       <motion.p
//         className="mt-2 z-10 text-[18px] leading-[138%] font-normal text-[#41335E] max-w-[280px] md:max-w-[300px] lg:max-w-[320px] font-gilroy"
//         variants={contentVariants}
//       >
//         {description}
//       </motion.p>
...
//       {/* Card Icon */}
//       <motion.div
//         className="relative z-10 w-[150px] h-[140px] md:w-[220px] md:h-[170px] mt-6 mb-2"
//         variants={contentVariants}
//       >
//         <Image src={icon} alt={title} width={220} height={170} />
//       </motion.div>
