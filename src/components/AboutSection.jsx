...
export default function AboutSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="about-section"
      className="relative bg-[#FFFFFF] text-[#333] pt-16 lg:pt-32 px-4 md:px-8 lg:px-12 pb-12 transform-gpu"
      style={{
  ...
  <AboutGrid />
      ...
      <motion.div
        className="relative inset-x-0 mt-[40px] lg:mt-[120px] lg:mb-[50px] z-[10] flex justify-center transform-gpu"
        initial="initial"
        whileInView="animate"
        viewport={{ once: true, margin: "-100px" }}
