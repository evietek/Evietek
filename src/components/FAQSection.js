...
const faqData = [
  ...
  },
  {
    ...
    answer: "You can reach us through our contact form on the website, email us at info@evietek.com, call our support line at +1 (647) 804-5528, or schedule a consultation through our online booking system."
  },
  {
...
const AccordionItem = ({ faq, isOpen, onToggle, itemIndex, columnType }) => {
  ...
  return (
    <div
      className={`border rounded-lg overflow-hidden mb-6 hover:shadow-lg hover:shadow-[#CCC8EE] transition-all duration-300 ease-in-out ${isOpen ? 'border-[#5E51FE]' : 'border-gray-200'}`}
    >
      <div
      ...
      >
        ...
        <button 
          className="w-8 h-8 flex items-center justify-center rounded-sm bg-gray-100 text-[#5E51FE] border border-[#5E51FE] transition-transform duration-300"
    ...
    <section className="bg-white pt-16 pb-8 px-6">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-[32px] sm:text-[40px] md:text-[48px] lg:text-[50px] leading-[107%] font-bricolage font-bold text-[#341E61] mb-12 select-none cursor-default text-center">
          ...
          <span className="text-[#341E61]">Asked Questions</span>
        </h2>
